    ...
    <div class="max-w-md mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-purple-200">
            <h2 class="text-2xl font-bold text-purple-600 mb-6">
                Nuevo {{ $canAssignAdmin ? 'Usuario' : 'Vendedor' }}
            </h2>
            ...
            <form method="POST" action="{{ route('admin.team.store') }}" class="space-y-4">
                ...
                @if ($canAssignAdmin)
                    <div>
                        ...
                        <select name="role" required class="mt-1 block w-full h-12 px-3 rounded-lg border-gray-300 shadow-sm">
                ...
                @else
                    <p class="text-xs text-gray-400">
                        Este usuario se creará con el rol de <strong>vendedor</strong>.
                    </p>
                @endif
